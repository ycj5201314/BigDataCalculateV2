            ...
            public void run() {
                ...
                for (int k=0;k<10;k++){
                    if (OriginData.isNotSeeven){
                        saveFileNameFinal[k]=SelectDataActivity.sdcardPath + "af"+(k+1) + "3.txt";
                    }else {
                        saveFileNameFinal[k]=SelectDataActivity.sdcardPath + "af"+(k+1) + "3for21.txt";
                    }
//                    saveFileNameFinal[k]=SelectDataActivity.sdcardPath+(k+1)+"ChangeFinal"+tag+".txt";
                    System.out.println("保存路径："+saveFileNameFinal[k]);
                }
                ...
                if (OriginData.isNotSeeven){
                    saveFileNameFinal[10]=SelectDataActivity.sdcardPath + "a113.txt";
                }else {
                    saveFileNameFinal[10]=SelectDataActivity.sdcardPath + "a113for21.txt";
                }
