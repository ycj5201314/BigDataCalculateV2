package com.example.frank.datacalculate;
...
import com.example.frank.datacalculate.config.OriginData;
import com.example.frank.datacalculate.utils.CheckPermissionUtils;
import com.example.frank.datacalculate.utils.DataResult;
import com.example.frank.datacalculate.utils.FileChooseUtil;
import com.example.frank.datacalculate.utils.Tools;
...
public class SelectDataActivity extends AppCompatActivity {
    ...
    public static String sevenSourcePath="",tweenSourcePath="";
    private TextView tv_seven,tv_tween;
    private Button startCompute,btnSelectSeven,btnSelectTweent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectSeven=findViewById(R.id.button13);
        btnSelectTweent=findViewById(R.id.button14);
        ...
        btnSelectSeven.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnSelectTweent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_GET_CONTENT);
                //intent.setType("image/*");//选择图片
        ...
        startCompute.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*if (sevenSourcePath.contains(".")&&tweenSourcePath.contains(".")){
                    ...
                    Toast.makeText(SelectDataActivity.this,"请选择数据文件进行加载后计算",Toast.LENGTH_LONG).show();
                }*/
                startActivity(new Intent(SelectDataActivity.this,InputComputeActivity.class));
                finish();
            }
        });
...
//            btnSelectSeven.setVisibility(View.INVISIBLE);
//            btnSelectTweent.setVisibility(View.INVISIBLE);
//            tv_seven.setVisibility(View.INVISIBLE);
//            tv_tween.setVisibility(View.INVISIBLE);
            startCompute.setText("正在计算，请稍候……");
            startCompute.setEnabled(false);
